...
(defvar chuck-exec "/opt/local/bin/chuck")
...
(defvar chuck-mode-map
  (let ((chuck-mode-map (make-keymap)))
    ...
    (define-key chuck-mode-map "\C-e" 'chuck-remove-code)  
    ...
    (define-key chuck-mode-map "\C-a" 'chuck-add-code)
